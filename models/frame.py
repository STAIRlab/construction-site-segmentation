"""
Analysis of a 3D frame structure using OpenSees
"""
...
def ReinforcedRectangle(model, id, h, b, cover, coreID, coverID, steelID, numBars, barArea, nfCoreY, nfCoreZ, nfCoverY, nfCoverZ, GJ):
    ...
    model.patch("quad", coverID, 1, nfCoverY, -coverY,  coverZ, - coreY,   coreZ,   coreY,   coreZ,   coverY,  coverZ, section=id)
    model.patch("quad", coverID, 1, nfCoverY, - coreY,  -coreZ, -coverY, -coverZ,  coverY, -coverZ,  coreY,  -coreZ, section=id)
    model.patch("quad", coverID, nfCoverZ, 1, -coverY,  coverZ, -coverY, -coverZ, -coreY,  -coreZ,  -coreY,   coreZ, section=id)
    model.patch("quad", coverID, nfCoverZ, 1,   coreY,   coreZ,   coreY,  -coreZ,   coverY, -coverZ,  coverY,  coverZ, section=id)
